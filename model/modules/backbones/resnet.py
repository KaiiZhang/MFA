...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, norm_layer=nn.BatchNorm2d, dilation=1):
        ...
        self.bn1 = norm_layer(planes)
        padding = dilation
        self.conv2 = conv3x3(planes, planes, stride, padding=padding, dilation=dilation)
        self.bn2 = norm_layer(planes)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False, norm_layer=nn.BatchNorm2d, first_conv_stride=2):
        ...
        self.layer3 = self._make_layer(block, 256, layers[2], stride=1, norm_layer=norm_layer, dilation=2)
        self.layer4 = self._make_layer(block, 512, layers[3], stride=1, norm_layer=norm_layer, dilation=4)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, norm_layer=nn.BatchNorm2d, dilation=1):
        downsample = None
